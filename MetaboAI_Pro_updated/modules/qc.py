...
def cv_distribution_plot(cv_table: pd.DataFrame):
    ...
    ax.set_title("QC CV Distribution", fontsize=11, fontweight="bold", loc="center")
    ax.legend()
    fig.tight_layout()
    return fig
...
def cv_histogram(cv_table: pd.DataFrame):
    ...
    ax.set_ylabel("Number of features")
    ax.set_title("Feature Count by CV Quality", fontsize=11, fontweight="bold", loc="center")
...
def sample_correlation_matrix(qc_log_data: pd.DataFrame):
    ...
    ax.set_title("QC Sample Correlation Matrix (QC replicates only)", fontsize=11, fontweight="bold", loc="center")
...
def peak_area_histogram(peak_df: pd.DataFrame, title: str = "Peak Area Distribution"):
    ...
    ax.set_title(title, fontsize=11, fontweight="bold", loc="center")
    fig.tight_layout()
    return fig
