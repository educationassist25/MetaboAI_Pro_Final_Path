...
def volcano_plot(
    ...
    if not hide_title:
        ...
        ax.set_title(final_title, fontsize=title_font_size, loc=title_align, pad=12,
    ...
    if show_legend:
        ...
        if legend_pos_key == "right":
            ...
            leg = fig.legend(handles=legend_handles, loc="center left", bbox_to_anchor=(legend_x, 0.55),
            ...
            leg = fig.legend(handles=legend_handles, loc="lower center", bbox_to_anchor=(0.5, legend_y),
            ...
            leg = fig.legend(handles=legend_handles, loc="upper center", bbox_to_anchor=(0.5, legend_y),
                             bbox_transform=fig.transFigure, fontsize=9.5, frameon=False, ncol=3,
                             title="Direction", title_fontsize=11.5)
